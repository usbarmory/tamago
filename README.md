...
[tamago1.23.6](https://github.com/usbarmory/tamago-go/tree/tamago1.23.6),
which [adds](https://github.com/golang/go/compare/go1.23.6...usbarmory:tamago1.23.6)
`GOOS=tamago` support to go1.23.6.
