...
[tamago1.15.8](https://github.com/f-secure-foundry/tamago-go/tree/tamago1.15.8),
which [adds](https://github.com/golang/go/compare/go1.15.8...f-secure-foundry:tamago1.15.8)
`GOOS=tamago` support to go1.15.8.
