...
[tamago1.22.2](https://github.com/usbarmory/tamago-go/tree/tamago1.22.2),
which [adds](https://github.com/golang/go/compare/go1.22.2...usbarmory:tamago1.22.2)
`GOOS=tamago` support to go1.22.2.
