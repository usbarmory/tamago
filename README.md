...
[tamago1.17.3](https://github.com/f-secure-foundry/tamago-go/tree/tamago1.17.3),
which [adds](https://github.com/golang/go/compare/go1.17.3...f-secure-foundry:tamago1.17.3)
`GOOS=tamago` support to go1.17.3.
