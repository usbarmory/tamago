...
[tamago1.17.1](https://github.com/f-secure-foundry/tamago-go/tree/tamago1.17.1),
which [adds](https://github.com/golang/go/compare/go1.17.1...f-secure-foundry:tamago1.17.1)
`GOOS=tamago` support to go1.17.1.
