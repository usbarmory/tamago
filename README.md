...
[tamago1.17.5](https://github.com/f-secure-foundry/tamago-go/tree/tamago1.17.5),
which [adds](https://github.com/golang/go/compare/go1.17.5...f-secure-foundry:tamago1.17.5)
`GOOS=tamago` support to go1.17.5.
