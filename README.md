...
[tamago1.16](https://github.com/f-secure-foundry/tamago-go/tree/tamago1.16),
which [adds](https://github.com/golang/go/compare/go1.16...f-secure-foundry:tamago1.16)
`GOOS=tamago` support to go1.16.
