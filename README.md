...
[tamago1.22.5](https://github.com/usbarmory/tamago-go/tree/tamago1.22.5),
which [adds](https://github.com/golang/go/compare/go1.22.5...usbarmory:tamago1.22.5)
`GOOS=tamago` support to go1.22.5.
