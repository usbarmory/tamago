...
// and 100 MHz) and the CPU clock (400 MHz nominal) are configured by the
// boot firmware before TamaGo starts. There is no runtime PLL configuration
// interface exposed to software.
const (
