...
//
// This function performs a full re-init so that the port works correctly
// regardless of the state left by any prior boot stage.
func (hw *UART) Init() {
	// Configure GPF11 = UART0_RXD (function 1), GPF12 = UART0_TXD (function 1).
	// SYS_GPF_MFPH bits [15:12] = GPF11 mux, bits [19:16] = GPF12 mux.
	// NUC980 Series Datasheet, p. 130 (§ 6.2.7 SYS_GPF_MFPH).
	v := reg.Read(REG_MFP_GPF_H)
	v &= 0xfff00fff // clear GPF11[15:12] and GPF12[19:16]
	v |= 0x00011000 // GPF11 = function 1 (UART0_RXD), GPF12 = function 1 (UART0_TXD)
	reg.Write(REG_MFP_GPF_H, v)
